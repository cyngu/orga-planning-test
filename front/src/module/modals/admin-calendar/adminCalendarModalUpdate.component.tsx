...
import CalendarUpdateForm from '~/module/admin/user-configuration/calendar/calendarUpdateForm/calendarUpdateForm.component';

const AdminCalendarUpdateModal = () => {
...
export default AdminCalendarUpdateModal;
