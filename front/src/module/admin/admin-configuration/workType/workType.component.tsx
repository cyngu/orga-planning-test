...
import workTypeImage from '../../../../../public/admin-image/workType.png';
        ...
        <>
            <div className="min-h-[100px] w-[60%] max-md:w-[95%] border shadow-lg">
                <div className="flex max-md:ml-2 items-center gap-5 md:ml-5 mt-3 ">
                    <Image src={workTypeImage} alt="parking" width={50} />
                    <h2 className="text-xl max-md:text-lg font-semibold">Type de fonction</h2>
                </div>
                <div>
                    <div className="flex justify-between mb-3 md:px-10 max-md:px-5 mt-10">
                        <p> Modifier les types de fonctions et la fonction par défaut.</p>
                        <button
                            type="button"
                            onClick={() => router.push('/admin/configuration/type-de-profil')}
