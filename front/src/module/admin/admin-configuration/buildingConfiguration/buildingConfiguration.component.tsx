...
import buildingImage from '../../../../../public/admin-image/building.png';
        ...
        <>
            <div className="min-h-[100px] w-[60%] max-md:w-[95%] border shadow-lg">
                <div className="flex max-md:ml-2 items-center gap-5 md:ml-5 mt-3 ">
                    <Image src={buildingImage} alt="parking" width={50} />
                    <h2 className="text-xl max-md:text-lg font-semibold">Configuration du bâtiment</h2>
                </div>
                <div>
                    <div className="flex justify-between mb-3 md:px-10 max-md:px-5 mt-10">
                        <p>Créer et modifier les entreprises au sein du bâtiment.</p>
                        <button
                            type="button"
                            onClick={() => router.push('/admin/configuration/configuration-du-batiment')}
