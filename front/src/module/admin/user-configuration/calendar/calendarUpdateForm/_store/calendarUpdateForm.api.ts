...
export const updateEventApi = async (eventsData: UpdateEventDataType, tokenAuth: string) => {
    try {
        const query = `
        mutation UpdateEventAdmin($id: String!, $userId: String!, $titleAm: String!, $titlePm: String!, $hourlyAm: String!, $hourlyPm: String!, $parking: Boolean! $workTime: String!) {
            updateEventAdmin(updateEventInput: {
                id: $id,
                userId: $userId,
                titleAm: $titleAm,
                titlePm: $titlePm,
