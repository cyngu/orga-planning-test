...
import ParkingPlaceConfigurationTable from '~/module/admin/admin-configuration/parkingPlaceConfiguration/parkingPlaceTable/parkingPlaceConfigurationTable.component';
import WorkTypeTable from '~/module/admin/admin-configuration/workType/workTypeTable/workTypeTable.component';

const ParkingPlaceConfigurationPage = () => {
            ...
            {isHydrating ? (
                <div className="relative w-[98%] shadow-lg flex max-md:flex-col bg-white gap-3 ">
                    ...
                    <div className="w-[100%] max-md:w-[90%] py-2 pl-2 mt-20">
                        <ParkingPlaceConfigurationTable />
                    </div>
                </div>
            ) : (
...
export default ParkingPlaceConfigurationPage;
