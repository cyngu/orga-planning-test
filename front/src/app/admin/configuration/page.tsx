...
import AdminConfiguration from '~/module/admin/admin-configuration/adminConfiguration.component';
        ...
        <>
            {isHydrating ? (
                <div className="relative w-[98%] shadow-lg flex max-md:flex-col bg-white gap-3">
                    ...
                    <div className="w-[100%] max-md:w-[90%] py-2 pl-2 mt-20 overflow-x-hidden">
                        <AdminConfiguration />
                    </div>
                </div>
            ) : (
